...
/// Controller trait — HTTP handlers with DI and lifecycle hooks.
pub trait Controller<M: Entity + serde::Serialize + 'static>: std::fmt::Debug + Send + Sync {
...
impl<M: Entity + serde::Serialize + 'static, S: Service<M> + 'static> Controller<M> for DefaultController<M, S> {
