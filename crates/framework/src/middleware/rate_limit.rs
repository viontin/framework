...
impl Middleware for RateLimitMiddleware {
    fn handle(&self, req: &mut Request, next: Next) -> Response {
        ...
        if crate::rate_limit::RateLimiter::global_is_limited(&key, self.max_attempts) {
            let retry_after = crate::rate_limit::RateLimiter::global_available_in(&key);
        ...
        crate::rate_limit::RateLimiter::global_hit(&key, self.decay_seconds);
        next(req)
    }
}
